...
For the complete list of 45 skills (1 router, 44 leaf skills) and 3 agents, upstream sources, and how they were adapted, see [docs/catalog.md](./docs/catalog.md).
