...
For the complete list of 37 skills (0 routers, 37 leaf skills) and 3 agents, upstream sources, and how they were adapted, see [docs/catalog.md](./docs/catalog.md). The repo also carries 4 repo-scoped graph-based skills under [`.claude/skills/`](./.claude/skills/) that are deliberately outside the catalog — see [Repo-scoped skills](./docs/catalog.md#repo-scoped-skills-not-in-the-installed-catalog).
