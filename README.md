...
For the complete list of 48 skills (4 routers, 44 leaf skills) and 3 agents, upstream sources, and how they were adapted, see [docs/catalog.md](./docs/catalog.md).
