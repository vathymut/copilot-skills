...
Per-template investigation questions for Phase 2 of the graphify onboard-mode workflow. For each template area, look for answers in the scan output first, then read source files to fill gaps.
