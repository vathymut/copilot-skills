...
description: Generates publication-quality figures for ML papers. Two workflows: architecture diagrams via Gemini, data charts via matplotlib/seaborn. Use when creating any figure for a conference paper.
version: 1.0.0
