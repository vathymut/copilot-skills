---
name: implement
description: "Implement work from a spec or set of tickets. Use after planning is complete and the user says implement / build / code it."
...
- Use `/tdd` at pre-agreed seams where it fits naturally.
