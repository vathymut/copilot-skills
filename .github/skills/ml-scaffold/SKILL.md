...
5. **Write placeholder** `journal/JOURNAL.md` (from `iterate-ml-experiment/templates/JOURNAL.md`) and return to `iterate-ml-experiment` § 0. Forbidden shortcuts: `references/forbidden-shortcuts.md`.
